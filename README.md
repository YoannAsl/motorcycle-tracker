...
- Files appear on the SD root as `gpslog-0001.csv`, `gpslog-0001.gpx`, and `session-0001.log`.
- After GPS time is valid, they are auto‑renamed to timestamped names (e.g., `gpslog-20250101_123045.*`).
...
Naming
- At boot: `gpslog-0001.csv`, `gpslog-0001.gpx`, `session-0001.log` (first free indexes)
- After GPS time is valid: auto‑renamed once to `gpslog-YYYYMMDD_HHMMSS.*` and `session-YYYYMMDD_HHMMSS.log`
